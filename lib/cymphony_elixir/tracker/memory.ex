defmodule CymphonyElixir.Tracker.Memory do
  @moduledoc """
  ...
  defp configured_issues do
    Application.get_env(:cymphony_elixir, :memory_tracker_issues, [])
  end
  ...
  defp send_event(message) do
    case Application.get_env(:cymphony_elixir, :memory_tracker_recipient) do
